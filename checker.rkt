...
(when (andmap struct? (list C1 C2 C3 C4))
  ...
  (check-part 'd .125 
              ...
              (λ (res) (or (list? res) "nu este o listă")))
  (check-part 'e .125 
              (serve '((ana 10) 2 (leo 5) 3 (maia 4) (dan 5) 1 (daria 5) (anca 4) (close 2) (ensure 5) 2 (clara 7) (alin 3) 3 (sonia 5) 1 (adi 4) (florin 7)
                                2 (horia 1) 1 (anda 2) 2 (ensure 3) (stela 7) (alma 10))
                     (list C1 C2 C3)
                     (list C4))
              (the friendly-output is)
              (list
              ...
              (λ (res) (or (list? res) "nu este o listă")))
  (check-part 'f .125 
              (serve '((ana 10) 2 (leo 5) (maia 4) (dan 5) 1 (daria 5) 2 (anca 4) (close 2) 2 (clara 7) 1 (alin 13) 3 (sonia 5) 1 (adi 6)
                                2 (florin 7) 2 (horia 4) 1 (anda 5) (stela 7) (close 4) 2 (ema 14) 5 (alma 10))
                     (list C1 C2)
                     (list C3 C4))
              (the friendly-output is)
              (list
